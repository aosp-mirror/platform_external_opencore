...
class ProgressiveDownloadState_GET : public DownloadState
{
    ...
    protected:
        ...
        void getStartFragmentInNewDownloadData(OUTPUT_DATA_QUEUE &aOutputQueue,
                                               bool &aUseAllNewDownloadData,
                                               uint32 &aStartFragsNo,
                                               uint32 &aStartFragOffset);
        void getEndFragmentInNewDownloadData(OUTPUT_DATA_QUEUE &aOutputQueue,
                                             uint32 &aEndFragNo,
