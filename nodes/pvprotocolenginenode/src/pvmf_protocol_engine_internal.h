...
class INetURI
{
    public:
        ...
        bool setURI(OSCL_wString &aUri, const bool aRedirectURI = false);
        ...
        bool getHostAndPort(OSCL_String &aSerAdd, int32 &aSerPort);
        bool empty()
        {
...
class HttpParsingBasicObject
{
    public:
        ...
        int32 isNewContentRangeInfoMatchingCurrentOne(const uint32 aPrevContentLength);
        ...
        int32 parseResponse(INPUT_DATA_QUEUE &aDataQueue);
        ...
        // factory method
        static HttpParsingBasicObject *create();
        // destructor
