...
bool INetURI::getHostAndPort(OSCL_String &aSerAdd, int32 &aSerPort)
{
...
bool HttpParsingBasicObject::getRedirectURI(OSCL_String &aRedirectUri)
{
...
bool HttpParsingBasicObject::getContentType(OSCL_String &aContentType)
{
...
////////////////////////////////////////////////////////////////////////////////////
int32 ProtocolState::processMicroState(INPUT_DATA_QUEUE &aDataQueue)
{
...
int32 ProtocolState::processMicroStateSendRequestPreCheck()
{
...
int32 ProtocolState::processMicroStateSendRequest()
{
...
int32 ProtocolState::doCompose(OsclMemoryFragment &aFrag)
{
    // compose
...
int32 ProtocolState::processMicroStateGetResponsePreCheck()
{
...
int32 ProtocolState::processMicroStateGetResponse(INPUT_DATA_QUEUE &aDataQueue)
{
...
int32 ProtocolState::checkParsingStatus(int32 parsingStatus)
{
    // error part
...
uint32 ProtocolState::getDownloadRate()
{
    ...
    LOGINFODATAPATH((0, "ProtocolState::getDownloadRate(), deltaMilliSec=%d, downloadSize=%d, downloadRate=%d, ",
                     deltaMilliSec, getDownloadSize(), (uint32)downloadRate));

    LOGINFODATAPATH((0, "ProtocolState::getDownloadRate(), deltaMilliSec1=%d, downloadSize1=%d, downloadRate1=%d",
                     deltaMilliSec1, pBWEstInfo->iTotalSizePerRequest, (uint32)downloadRate1));
...
bool ProtocolState::setExtensionFields(Oscl_Vector<OSCL_HeapString<OsclMemAllocator>, OsclMemAllocator> &aExtensionHeaderKeys,
...
bool ProtocolState::constructAuthenHeader(OSCL_String &aUserID, OSCL_String &aPasswd)
{
